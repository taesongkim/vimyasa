...
Live release: **v0.1.11**. Planned next sequence:
...
| **v0.1.12** | Deferred v0.1.10/v0.1.11 items | Backup / restore user data (P1). Focus-state visual cue (P2). Mystery flicker on first entry-form launch (P2). Onboarding dim z-order (P3). Scrollbar tracking lag (P3). Auto-updater EPIPE defensive wrap (P3). Coordination: auto-update integrity audit. All pushed here so v0.1.11 could ship as a tight hotfix. |
