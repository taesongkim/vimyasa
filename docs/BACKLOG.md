...
- **Status:** **in-flight on `undo-redo` branch** (features lane). Dispatched 2026-06-25 with revised scope (cross-list, 5-step ring buffer, shared Zustand renderer store with broadcast).
