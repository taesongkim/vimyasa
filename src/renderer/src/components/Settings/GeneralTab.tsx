  ...
  return (
    <div className="flex flex-col gap-3 px-1 py-3">
      ...
      <div className="flex flex-col gap-1">
        ...
        <div className="text-[length:var(--font-size-sm)] text-[color:var(--color-text-muted)]">Vimyasa v0.1.0</div>
        <div className="text-[length:var(--font-size-sm)] text-[color:var(--color-text-ghost)]">Keyboard-first list manager for macOS</div>
      </div>
    </div>
  )
}
